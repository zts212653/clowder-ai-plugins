...
The connector contributes one Feishu identity, connector surface, and verified webhook, requesting only
`messaging.send`. QR setup obtains credentials but does not transfer Host configuration authority.
